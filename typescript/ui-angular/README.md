...
- [Angular SDK docs](https://github.com/langchain-ai/langgraphjs/tree/main/libs/sdk-angular/docs): `injectStream`, streamed values, optimistic updates, and Angular integration patterns.
