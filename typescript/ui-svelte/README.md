...
- [Svelte SDK docs](https://github.com/langchain-ai/langgraphjs/tree/main/libs/sdk-svelte/docs): `useStream`, streamed values, optimistic updates, and Svelte integration patterns.
